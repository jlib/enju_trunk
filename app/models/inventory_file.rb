class InventoryFile < ActiveRecord::Base
  ...
  validates_attachment_content_type :inventory, :content_type => ['text/csv', 'text/plain', 'text/tab-separated-values'], :message => I18n.t('activerecord.errors.messages.invalid_content_type')
